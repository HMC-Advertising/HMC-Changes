			...
			<div class="col-lg-12">
				<div class="container">
					<div class="col-xs-12 col-sm-8">
						...
						<a href="https://www.stoweonestore.com/eStore/Content/Commerce/Products/DisplayProducts.aspx?ProductGroupCode=1000002&ProductCategoryCode=826" target="_blank" class="button red" id="Weathernext_Ready">Ready. Set. Ski!</a>
		...
		<div class="col-lg-12">
			<div class="container">
				<div class="col-lg-12">
					...
					<a href="/ski-ride/bypass/" class="button red" id="Weathernext_Discover">Discover the Benefits</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="col-lg-12">
			<div class="container">
				<div class="col-lg-12">
					...
					<a href="/plan/lodging/" class="button red" id="Weathernext_Book">Book Now</a>
				</div>
			</div>
		</div>
	</div>
...
<script type='text/javascript'>
	(function($){
		$('#Weathernext_Book').on('click', function() {
			var href = $(this).attr('href');
				_gaq.push(['_trackEvent', 'Weathernext', 'Book', href]);
		});
		$('#Weathernext_Discover').on('click', function() {
			var href = $(this).attr('href');
	        _gaq.push(['_trackEvent', 'Weathernext', 'Discover', href]);
		});
		$('#Weathernext_Ready').on('click', function() {
			var href = $(this).attr('href');
	        _gaq.push(['_trackEvent', 'Weathernext', 'Ready', href]);
		});
	}(jQuery))
</script>
